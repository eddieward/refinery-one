...
ActiveRecord::Schema.define(:version => 20110205014418) do
  ...
  add_index "attachments", ["id"], :name => "index_attachments_on_id"
  ...
  add_index "instructions", ["id"], :name => "index_instructions_on_id"
